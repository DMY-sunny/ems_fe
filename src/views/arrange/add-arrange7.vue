<template>
    <div>
        <div class="h100 left_img"><img :src="cdn04 + 'activity/page7.png'" alt=""></div>
            ...
            <div>
                ...
                <div class="right_box">
                    <div v-for="(sitem,sindex) in ruleForm.top_data" :key="sindex" class="div1">
                        <p>
                            <span class="text">链接{{sindex + 1}}</span>
                            <!-- <el-button type="danger" v-if="sindex > 0" @click="deleteTopData(sindex)">删除</el-button> -->
                        </p>
                        <el-select v-model="sitem.act_type" placeholder="请选择活动类型">
                            <el-option :label="item.desc" :value="item.act_type" v-for="(item,index) in act_list" :key="index"></el-option>
                        </el-select>
            ...
            <div>
                ...
                <div class="right_box">
                    <div v-for="(sitem,sindex) in ruleForm.zong_data" :key="sindex" class="div1">
                        ...
                        <el-input v-model="sitem.act_id" placeholder="填写活动id"></el-input>
                        <el-input v-model="sitem.tag" placeholder="tab文案第一行" maxlength="5" show-word-limit></el-input>
...
export default {
    ...
    created() {
        cmsGetData({ id: 164, tag: 'YEARACT7' }).then(res => {
            this.ruleForm = JSON.parse(res.data.data)
            this.show_page = true
        })
        cmsGetData({ id: 164, tag: 'YEARACT17' }).then(res => {
