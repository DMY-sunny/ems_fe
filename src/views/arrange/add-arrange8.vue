<template>
    <div>
        <div class="h100 left_img"><img :src="cdn04 + 'activity/page8.png'" alt=""></div>
        <div class="right_wrap h100" v-if="show_page">
            ...
            <div>
                ...
                <div class="right_box">
                    <div v-for="(sitem,sindex) in ruleForm.discount_list" :key="sindex" class="div1">
                        <p>
                            <span class="text">秒杀场次{{sindex + 1}}</span>
                            <el-button type="danger" v-if="sindex > 0" @click="deleteDiscountList(sindex)">删除</el-button>
                        </p>
                        <el-select v-model="sitem.act_type" placeholder="请选择活动类型">
                            <el-option :label="item.desc" :value="item.act_type" v-for="(item,index) in act_list" :key="index"></el-option>
                        </el-select>
                    ...
                    <el-button type="primary" @click="addDiscountList">新增</el-button>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="right_box">
                    <div v-for="(sitem,sindex) in ruleForm.zong_data" :key="sindex" class="div1">
                        ...
                        <el-input v-model="sitem.icon" placeholder="tab文案第二行" maxlength="5" show-word-limit></el-input>
                    </div>
...
export default {
    ...
    created() {
        cmsGetData({ id: 164, tag: 'YEARACT8' }).then(res => {
    ...
    methods: {
        ...
        addDiscountList() {
            this.$confirm('确定新增场次吗', '提示', {
                ...
                this.ruleForm.discount_list.push({
                    act_type: '6',
                    act_id: '',
                    start_time: '',
                    end_time: '',
        ...
        deleteDiscountList(index) {
            this.$confirm('确定删除场次吗', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                this.ruleForm.discount_list.splice(index, 1)
            })
        },
        addZongData() {
