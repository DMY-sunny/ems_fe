        ...
        <uploader ref="uploader" :options="options" :autoStart="false" @file-added="onFileAdded" @file-success="onFileSuccess" @file-progress="onFileProgress" @file-error="onFileError" class="uploader-app">
            ...
            <uploader-list v-show="panelShow">
                <div class="file-panel" slot-scope="props" :class="{'collapse': collapse}">
                    ...
                    <ul class="file-list">
                        <li v-for="file in props.fileList.slice(-1)" :key="file.id">
...
export default {
    ...
    data() {
        return {
            options: {
                target: "/api/upload/bigfile",
                chunkSize: '838860',//0.8mb
                // chunkSize: '1048576',//1.0mb
                ...
                checkChunkUploadedByResponse: function (chunk, message) {
                    ...
                    return (objMessage.data.uploaded.map(Number) || []).indexOf(chunk.offset + 1) >= 0
                },
                headers: {
    ...
    methods: {
        ...
        onFileSuccess(rootFile, file, response, chunk) {
            ...
            if (res.errno !== 0 || this.resError) {
                if(res.errmsg) this.$message.error(res.errmsg);
                // 文件状态设为“失败”
